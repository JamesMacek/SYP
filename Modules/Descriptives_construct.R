...
data2plot["Emp_tot_growth"] <- (data2plot$La2010 + data2plot$Ln2010)/(data2plot$La2000 + data2plot$Ln2000) -  1*rep(1, nrow(data2plot))
...
ag_glm_2010 <- lm_robust(ag_emp_cont_2010~Emp_density_2000, data=data2plot)
na_glm_2010 <-  lm_robust(na_emp_cont_2010 ~ Emp_density_2000, data=data2plot)
