...
#Outputing data on land prices/use for use with other programs.
...
c_na_2010_new = c_na_2010_new*(pindex_na(c_na_2010, 2010)^(phi_nn))*(pindex_ag(c_ag_2010, 2010)^(phi_an))/master$dTFP[master$sector == "na" & master$year == 2010]
...
#TEST: Relative values of old+new cost and prices should be equal within sectors and years.
test_na_2005 <- c_na_2005/master$dcost[master$year==2005 & master$sector=="na"]
test_ag_2005 <- c_ag_2005/master$dcost[master$year==2005 & master$sector=="ag"]
test_na_2010 <- c_na_2010/master$dcost[master$year==2010 & master$sector=="na"]
test_ag_2010 <- c_ag_2010/master$dcost[master$year==2010 & master$sector=="ag"]
#Constant up to machine precision. 
