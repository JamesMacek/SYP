...
P_temp2005 = exp([1 - parameters.phi_aa, -parameters.phi_na ; -parameters.phi_an, 1 - parameters.phi_nn]*[log(parameters1.Gn_2005_nls(1)*parameters1.Ga_Gn_2005(1)) ; log(parameters1.Gn_2005_nls(1))]) ; 
parameters.Pa_2005 = P_temp2005(1) ;
parameters.Pn_2005 = P_temp2005(2) ;

P_temp2010 = exp([1 - parameters.phi_aa, -parameters.phi_na ; -parameters.phi_an, 1 - parameters.phi_nn]*[log(parameters1.Gn_2010_nls(1)*parameters1.Ga_Gn_2010(1)) ; log(parameters1.Gn_2010_nls(1))]) ;
...
%Reshaping employment back into desired matrix
...
dWage_2005 = (co_obj.nomY_2005./Lab_2005)./(co_obj.nomY_2000./co_obj.emp_lab_2000) ; %Change in gross output per worker-- or change in value added per worker=change in wage per worker
G_2005 = co_obj.nomY_2005./Lab_2005 ; %Gross output per worker in levels
aG_2005 = co_obj.nomY_2005 ; %Gross output in levels
...
dResidential_land_2005([1:30], 2) = dCommercial_land_2005([1:30], 2) ; %change in residential land = change in commercial land if all workers paid same value added
...
temp_2005_tc = [tradec.ag_2007./tradec.ag_2002, tradec.na_2007./tradec.na_2002; tradec.ag_2007./tradec.ag_2002, tradec.na_2007./tradec.na_2002].^(-1) ; %NOTE: No trade costs in some specifications + trade cost data already to power of trade elasticity
...
temp_2005_Y = repelem([aG_2005(:, 1) ; aG_2005(:, 2)], 1, N) ; %Matrix of gross output in 2005
